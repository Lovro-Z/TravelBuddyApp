...
insert into travel(id, travel_name, short_description, description, price, space_left, transportation, image_url)
values (104, 'Travel to Japan', 'Travel to one of the oldest, modern and famous countries in the world, Japan!', 'Day 1 of the trip (October 17) Zagreb - Dubai
Meeting of travel participants at the Franjo Tuđman Airport in Zagreb 120 minutes before the departure of the aircraft. After the distribution of travel documents, check-in
Day 2 of the trip (October 18) Dubai - Tokyo. Arrival in Tokyo is scheduled for 5:35 p.m. local time. After completing the customs formalities and welcoming the local agent, transfer to the hotel follows. Check-in and accommodation in a hotel in the central part of Tokyo. Overnight. 3rd day of travel (19.10.) Tokyo - city tour
After breakfast, we suggest a city tour accompanied by a local guide, public transport. We start the tour by visiting the Imperial Palace Square, which is located on the
site of the former Edo Castle, and has been home to the imperial family since 1888. We continue to the once largest fish market in the world Tsukiji market, which consists of several blocks of shops and restaurants where in addition
to fish and seafood you can find a variety of food processing products such as knives. Lunch at a local restaurant follows (surcharge). In the afternoon visit to the oldest Buddhist temple in Tokyo. Sensoji Temple is located in the
Asakusa district and is one of the most important temples in Tokyo. Our last destination today is the artificial island of Odaiba, which shows the futuristic side of Tokyo, and is teeming with numerous cultural and commercial attractions.
We suggest a visit to the newly opened teamLab digital art museum (ticket is not included in the price of the trip). The museum presents 50 digital works realized with a capacity of 520 computers and 470 projectors, and through modern
technologies and designs creates the impression of alternative reality and illusion. Return to the hotel. Overnight.', 2700, 65, 'PLANE', 'https://theasiacollective.com/wp-content/uploads/2018/06/Feature-Photo-1-e1530688449976.png');
